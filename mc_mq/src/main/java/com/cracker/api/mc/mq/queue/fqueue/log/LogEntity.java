...
public class LogEntity
{
	...
	public byte write(byte[] log)
	{
		...
		if (isFull(increment)) 
		{
			...
			logger.warn("when writefull，has wroten Object total num is: {}",  integerCounter.get());
			return WRITEFULL;
		}
		...
		logger.error("Successfully write Object to FQueue，total num is: {}",  integerCounter.incrementAndGet());
		return WRITESUCCESS;
	}
